...
global.ownername = process.env.OWNER_NAME || "LYTA";
global.packname = process.env.PACK_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.author = process.env.AUTHOR || "LYTA ";
global.channelname = process.env.CHANNEL_NAME || "LYTA";
...
// Messages
global.mess = {
    success: process.env.MESSAGE_SUCCESS || 'anita is 𝙳𝚘𝚗𝚎',
    ...
    wait: process.env.MESSAGE_WAIT || '_*Please Wait anita is dancing*_',
